...
context('Network Requests', () => {
  it('can get people', () => {
    cy.request('https://www.swapi.tech/api/people').should(response => {
      expect(response.status).to.eq(200);
    });
  });

  it('can get character', () => {
    cy.request('https://www.swapi.tech/api/people/1').should(response => {
      expect(response.status).to.eq(200);
    });
  });

  it('can get planet', () => {
    cy.request('https://www.swapi.tech/api/planet/1').should(response => {
      expect(response.status).to.eq(200);
    });
  });
